/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ac12f775029eedae501665270a73a0f)
// Runtime types generated with workerd@1.20260917.1 2025-09-01 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ELEVENLABS_API_KEY: string;
	OPENAI_API_KEY: string;
	OPENROUTER_API_KEY: string;
	BroadcastAgent: DurableObjectNamespace<import("./worker/index").BroadcastAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BroadcastAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ELEVENLABS_API_KEY" | "OPENAI_API_KEY" | "OPENROUTER_API_KEY">> {}
}
